...
begin
   ...
   begin
      ...
      Label1.Top:= lePass.Top - 15;
      leAdress.Left:= 20;
      leLogin.Left:= leAdress.Left;
      lePass.Left:= leAdress.Left;
      Label1.Left:= leAdress.Left + 2;
...
begin
   ...
   begin
      ...
      Screen.Canvas.TextOut(10,Current - (Trunc(one / 2) + 3),'График по дням');
   ...
   begin
      ...
      Screen.Canvas.TextOut(10,Current - (Trunc(one / 2) + 3),'График по неделям');
      Screen.Canvas.MoveTo(LeftField,Current + 15);
   end;
   ...
   begin
      ...
      Screen.Canvas.TextOut(10,Current - (Trunc(one / 2) + 3),'График по году');
   end;
end;
